...
class UserServiceTest {
    ...
    void createAssignment() {
        ...
        assertEquals(title, assignment.title());
        assertEquals(createdAt, assignment.createdAt());
        ...
        assertEquals(files, assignment.files());
        assertEquals(feedback, assignment.feedback());
    }
}